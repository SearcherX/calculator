        ...
        <section class="h-screen home-page">
            <div class="items-center justify-center flex flex-col container gap-20 h-full lg:flex-row m-auto w-full">
                ...
                <span class="text-gray-700 text-2xl lg:text-3xl">
                  Меня зовут <b>Найденов Александр Евгеньевич</b> <br> Это мой первый проект, на стеке HTML, CSS, JS, PHP, SQL
                </span>
                    </div>
                    ...
                    <ul class="flex flex-col gap-12 px-8 relative">
                        ...
                        <li id="listItem3">
                            ...
                            <div>
                                ...
                                <a target="_blank" href="https://github.com/SearcherX" class="font-semibold text-gray-700 text-xl">GitHub</a>
                        ...
                        <li id="listItem4">
                            ...
                            <div>
                                <a href="/mvc/calculator" target="_blank" class="font-semibold text-gray-700 text-xl">Калькулятор</a>
