...
class CalculatorController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $monthsList = RenderHelper::getDropDownArray(Yii::$app->params['lists']['months']);
        $tonnagesList = RenderHelper::getDropDownArray(Yii::$app->params['lists']['tonnages']);
        $raw_typesList = RenderHelper::getDropDownArray(Yii::$app->params['lists']['raw_types']);
        $price = null;
        $raw_typePrices = null;
        $headTableTM = null;
